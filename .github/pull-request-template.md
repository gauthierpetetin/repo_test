...
- [ ] I’ve followed [MetaMask Coding Standards](./coding_guidelines/CODING_GUIDELINES.md).
...
- [ ] I’ve applied the right labels on the PR (see [labeling guidelines](./coding_guidelines/LABELING_GUIDELINES_MOBILE.md)).
