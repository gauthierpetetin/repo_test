...
- [ ] I’ve followed [MetaMask Coding Standards](https://github.com/gauthierpetetin-test/repo_test/blob/main/.github/coding_guidelines/CODING_GUIDELINES.md).
...
- [ ] I’ve applied the right labels on the PR (see [labeling guidelines](https://github.com/gauthierpetetin-test/repo_test/blob/main/.github/coding_guidelines/LABELING_GUIDELINES_MOBILE.md)).
